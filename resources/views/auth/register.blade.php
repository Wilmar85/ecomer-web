    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                ...
                <h2 class="mt-2 text-3xl font-extrabold text-white tracking-tight">Crear cuenta</h2>
            </div>
            <form class="bg-white p-8 rounded-lg shadow-lg space-y-6 animate-fade-in-up" method="POST" action="{{ route('register') }}">
                @csrf
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input id="name" name="name" type="text" autocomplete="name" required autofocus class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition" value="{{ old('name') }}">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input id="email" name="email" type="email" autocomplete="username" required class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition" value="{{ old('email') }}">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input id="password" name="password" type="password" autocomplete="new-password" required class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition">
                    </div>
