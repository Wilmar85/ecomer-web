<footer class="bg-gray-800 text-white mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-semibold">Acerca de Nosotros</h3>
                ...
                <ul class="space-y-1 text-gray-300 text-sm">
                    ...
                    <li><a href="#" class="hover:text-white">Información de Envío: Domicilio a la ciudad o puesto en transportadora</a></li>
                    <li><a href="#" class="hover:text-white">Métodos de Pago: Transferencia, PSE, Tarjeta</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2 text-gray-300 text-sm">
                    <li><a href="#" class="hover:text-white">Preguntas Frecuentes (FAQ)</a></li>
                    <li><a href="#" class="hover:text-white">Contacto: WhatsApp ventas 320 303 0595, 320 303 0596</a></li>
                    <li><a href="#" class="hover:text-white">Devoluciones y Garantías</a>
            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-3 items-center">
                    ...
                    <img src="{{ asset('images/payments/amex.png') }}" alt="Amex" class="h-8">
                    <img src="{{ asset('images/payments/pse.png') }}" alt="PSE" class="h-8">
                    <img src="{{ asset('images/payments/bank.png') }}" alt="Transferencia" class="h-8">
                </div>
                    <li><a href="{{ route('about') }}" class="text-gray-300 hover:text-white">Sobre nosotros</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-300 hover:text-white">Contacto</a></li>
                </ul>
            </div>
        ...
        <div class="w-full flex flex-col items-center justify-center mt-8">
            ...
            <div class="flex space-x-4 mb-4">
                <a href="#" class="text-gray-300 hover:text-white" title="Facebook">
                ...
                <a href="#" class="text-gray-300 hover:text-white" title="Twitter">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/></svg>
                </a>
            </div>
            <div class="border-t border-gray-700 pt-4 w-full text-center text-gray-300 text-sm">
