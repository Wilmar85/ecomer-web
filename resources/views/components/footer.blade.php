    ...
    <div class="footer__container">
        <div class="footer__grid">
            ...
            <div class="footer__section">
                ...
                <div class="footer__flex space-x-3 items-center">
                    ...
                    <li><a href="{{ route('about') }}" class="footer__text-secondary footer__link--hover">Sobre nosotros</a></li>
                    <li><a href="{{ route('contact') }}" class="footer__text-secondary footer__link--hover">Contacto</a></li>
                </ul>
            </div>
                    ...
                    @foreach ($categories as $category)
                        <li>
                            <a href="{{ route('shop.index', ['category' => $category->id]) }}" 
                               class="footer__text-secondary footer__link--hover">
                                {{ $category->name }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div>
                ...
                <ul class="footer__list footer__text-secondary">
        ...
        <div class="footer__social-section">
            ...
            <div class="footer__social-links">
                <a href="#" class="footer__text-secondary footer__link--hover" title="Facebook">
                ...
                <a href="#" class="footer__text-secondary footer__link--hover" title="Instagram">
                ...
                <a href="#" class="footer__text-secondary footer__link--hover" title="Twitter">
